...
Questions adapted for electrical stimulation: pain, tingling, sharpness.
...
VAS_QUESTIONS = [
    {'key': 'pain',     'text': 'How intense was the PAIN sensation?'},
    {'key': 'tingling', 'text': 'How intense was the TINGLING sensation?'},
    {'key': 'sharpness','text': 'How SHARP was the sensation?'},
]
