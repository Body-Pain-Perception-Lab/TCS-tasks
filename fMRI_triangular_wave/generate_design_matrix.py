...
This script models a UNIPOLAR triangle waveform (40s period, 0.025 Hz)
...
Use cluster_fourier/fourier_analysis.py for phase-encoding analysis instead.
...
def get_block_plan(config):
    """Return the 8-block sequence based on config.
